  ...
  return (
    <>
              ...
              <form onSubmit={handleLogin} className="space-y-6">
                ...
                <div className="text-center mt-4">
                  <button 
                    ...
                    className="text-xs font-lexend font-normal text-[#839590] hover:text-[#0A2C25] transition-colors bg-transparent border-none cursor-pointer"
                  >
      ...
      <DiscardConfirmModal 
        ...
        description={
          <>
            Por seguridad, las contraseñas actuales de <strong className="text-[#0A2C25]">Cubi</strong> están encriptadas y no son visibles en el sistema.<br /><br />
            Si perdiste tu acceso, por favor <strong className="text-[#3786E6]">contacta al Administrador o a Jefatura</strong> para que te asignen una nueva contraseña.
          </>
        }
        confirmLabel="Entendido"
        cancelLabel="Volver"
        onClose={() => setShowForgotModal(false)}
        onConfirm={() => setShowForgotModal(false)}
        icon={<Lock className="w-8 h-8 text-[#3786E6]" />} 
        iconBgColor="bg-blue-50"
        confirmBtnColor="bg-[#3786E6] hover:bg-[#0956B6] shadow-blue-200"
      />
    </>
  );
}