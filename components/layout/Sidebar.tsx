...
export default function Sidebar() {
  ...
  // PASO 1: Esta función ahora solo abre el modal
  function handleLogoutClick() {
    if (isMobileMenuOpen) {
      setIsMobileMenuOpen(false); // Ocultamos el menú móvil para que no tape el modal
    }
    setShowLogoutConfirm(true);
  }

  // PASO 2: Esta función ejecuta la salida real (se llama desde el modal)
  ...
  return (
    <>
      ...
      <DiscardConfirmModal 
        ...
        title="¿CERRAR SESIÓN?"
        description="¿Estás seguro de que deseas salir de Cubi? Tendrás que volver a ingresar tus credenciales para acceder al sistema."
